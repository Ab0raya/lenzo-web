          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="glass-panel p-6 rounded-2xl border border-white/10 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg font-black text-white">{t.reference.mappingTitle}</h3>
                  <span className="text-xs font-mono text-gray-400">{t.reference.mappingSubtitle}</span>
                </div>
              </div>
              <p className="text-sm text-gray-300 leading-relaxed">
                {t.reference.mappingDesc}
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3 p-4 rounded-xl bg-[#0A0A0A] border border-white/10">
                ...
                <div>
                  <h4 className="text-xs font-bold text-white uppercase tracking-wider font-mono">{t.reference.clipDesignTitle}</h4>
                  <p className="text-xs text-gray-400 mt-1">{t.reference.clipDesignDesc}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 rounded-xl bg-[#0A0A0A] border border-white/10">
                ...
                <div>
                  <h4 className="text-xs font-bold text-white uppercase tracking-wider font-mono">{t.reference.dualPhaseTitle}</h4>
                  <p className="text-xs text-gray-400 mt-1">{t.reference.dualPhaseDesc}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 rounded-xl bg-[#0A0A0A] border border-white/10">
                ...
                <div>
                  <h4 className="text-xs font-bold text-white uppercase tracking-wider font-mono">{t.reference.printableTitle}</h4>
                  <p className="text-xs text-gray-400 mt-1">{t.reference.printableDesc}</p>
                </div>
              </div>
